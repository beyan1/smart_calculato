...
logoLabel = Label(root, image=logoImage, bg='navy')
logoLabel.grid(row=0, column=0)

entryField = Entry(root, font=('arial', 20, 'bold'), bg='navy', fg='white', bd=10, relief=SUNKEN, width=30)
entryField.grid(row=0, column=0, columnspan=8)

micImage = PhotoImage(file='microphone.png')
micButton = Button(root, image=micImage, bd=0, bg='navy', activebackground='navy'
                   ,command=audio)
...
for i in button_text_list:
    ...
    button = Button(root, width=5, height=2, bd=2, relief=SUNKEN, text=i, bg='navy', fg='white',
                    font=('arial', 18, 'bold'), activebackground='navy', command=lambda button=i: click(button))
